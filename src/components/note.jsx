...
function Note(props){ //note  function 
    const [visibilitycheck, changeVisibility] =useState(null);
    ...
    function visible(event){
        const visibility = Number(event.currentTarget.id);
    ...
    return(
             <AnimatePresence>
                ...
                onMouseOver={visible}
                onMouseOut={()=>{changeVisibility(null)}}
                id={props.id} onClick={props.divstyle}
                style={{backgroundColor: props.notebackcolor==="" ? "": props.notebackcolor}}>
